          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            ...
            >
              <div style={{ 
                ...
                <div style={{ position: 'absolute', left: 0, top: '4px', width: '3px', height: '12px', backgroundColor: styleColor || 'var(--text-muted)', borderTopRightRadius: '4px', borderBottomRightRadius: '4px' }} />
              </div>
              Corner
            </button>
