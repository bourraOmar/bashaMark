              ...
              <div>
                ...
                <Row label="Number of columns">
                  <SelectDropdown 
                    ...
                    onChange={(v) => {
                      ...
                      setSettings({ ...settings, numberOfColumns: v, boardWidth: newWidth });
                    }}
                ...
                <div style={{ marginBottom: '16px' }}>
                  {(() => {
                    ...
                    return (
                      <>
                        <Row label="Board width"><span style={{fontSize:'0.85rem', color:'var(--text-muted)'}}>{Math.min(settings.boardWidth, maxBoardWidth)}px</span></Row>
                        <Slider value={Math.min(settings.boardWidth, maxBoardWidth)} min={190} max={maxBoardWidth} onChange={(v) => handleChange('boardWidth', v)} />
                      </>
                    );
                  })()}
                </div>
